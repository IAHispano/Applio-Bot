    ...
    try {
      ...
      switch (command) {
        case "start":
          {
            const reason =
              interaction.options.get("reason")?.value ?? "I'm AFK :)";
      ...
      console.log(error);
      interaction.reply({
        content: "I have not been able to execute this command as I do not have the necessary permissions to create moderation rules to prevent you from being mentioned!",
        ephemeral: true,
      });
    }
  },
