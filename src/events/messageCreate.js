  ...
  async execute(message) {
    ...
    if (message.type === 19 && message.reference) {
      ...
      if (!args[1] || !args[1].trim()) {
        ...
        .setTitle("Applio Bot")
        .setDescription("Applio is a Voice Conversion based on VITS focused on simplicity, quality and performance, if you need to know more about it, you can check [Website](https://applio.org) or [Github](https://github.com/IAHispano/Applio). \n Commands: \n - </search:1229146911483760781>\n- </searchuser:1232443891513561141>\n- </chat:1234277316994007040> \n*And More...*")
        ...
        const inviteBot = new ButtonBuilder()
            .setStyle(5)
            .setURL("https://discord.com/api/oauth2/authorize?client_id=1144714449563955302&permissions=1376674433127&scope=bot")
            .setLabel("Invite")
            .setEmoji("🪛");
